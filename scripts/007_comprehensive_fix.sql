...
-- Add fields for dynamic stats and category images to website_settings
-- Add a testimonials table properly linked
...
-- Now fix the orders -> profiles relationship
ALTER TABLE orders 
...
-- Add stats fields to website_settings
...
-- Add category management to website_settings
ALTER TABLE website_settings 
...
-- Update the default settings row if it exists
...
-- Grant proper permissions for the testimonials table (already exists)
